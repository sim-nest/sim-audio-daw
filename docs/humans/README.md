...
| `feature/sim-audio-daw/audio-graph-workbench` | `crate/sim-lib-audio-graph-core` | 3 | Compose offline and realtime audio graphs with reusable bandlimited oscillators, fixed-state polyphase resampling, filters, dynamics, effects, and bounded preview output. |
...
| `feature/sim-audio-daw/native-media-ports` | `crate/sim-audio-ports` | 1 | Describe native audio devices and plugins without importing platform APIs into audio semantics. |
...
- `crates/sim-lib-audio-dsp/recipes/01-basics/bandlimited-resample/purpose.md`
- `crates/sim-lib-audio-dsp/recipes/01-basics/bandlimited-resample/recipe.toml`
- `crates/sim-lib-audio-dsp/recipes/01-basics/bandlimited-resample/setup.siml`
...
Specimen `spec-test/sim-audio-daw/crates/sim-lib-audio-graph-live/src/tests/runner` is checked by `cargo test`.

Source `crates/sim-lib-audio-graph-live/src/tests/runner.rs`:
...
### `feature/sim-audio-daw/native-media-ports`
