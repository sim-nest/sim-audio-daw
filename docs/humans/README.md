...
| `feature/sim-audio-daw/audio-graph-workbench` | `crate/sim-lib-audio-graph-core` | 3 | Compose offline and realtime audio graphs with reusable filters, waveshaping, dynamics, delay/modulation effects, and bounded preview output. |
